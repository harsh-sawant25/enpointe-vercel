        ...
        <div className={`${interregular.className} bg-[#171717] text-[#f5f5f0]`}>
            ...
            <section className="relative px-5 md:px-20 pt-40 pb-20 min-h-[50vh] flex flex-col justify-end border-b border-white/10 overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto">
                    <div className={`${interregular.className} text-[11px] tracking-[0.2em] uppercase text-[#A6DAFF] mb-4`}>
                        Industries / Experiences & Attractions
                    </div>
                    <h1 className={`${interbold.className} text-[52px] md:text-[116px] font-bold leading-[0.92] tracking-[-0.04em] mb-6 text-white uppercase`}>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 md:gap-[60px] mt-10 items-start">
                        <div className="md:sticky md:top-24">
                            ...
                            <h2 className={`${interbold.className} text-[clamp(2rem,4.5vw,4rem)] font-bold leading-[1.05] tracking-[-0.025em] mb-5 text-white`}>EMAAR</h2>
                        ...
                        <div>
                            ...
                            <h3 className={`${interbold.className} text-[clamp(1.4rem,3vw,2.4rem)] font-bold leading-[1.1] tracking-[-0.02em] mb-4 text-white`}>Our Solution: Unified Ticketing Ecosystem</h3>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 md:gap-[60px] mt-10 items-start">
                        <div className="md:sticky md:top-24">
                            ...
                            <h2 className={`${interbold.className} text-[clamp(2rem,4.5vw,4rem)] font-bold leading-[1.05] tracking-[-0.025em] mb-5 text-white`}>Get Hayya</h2>
                            <p className={`${interregular.className} text-base md:text-[1.05rem] text-white/50 font-normal leading-[1.75] mt-4`}>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 md:gap-[60px] mt-10 items-start">
                        <div className="md:sticky md:top-24">
                            ...
                            <h2 className={`${interbold.className} text-[clamp(2rem,4.5vw,4rem)] font-bold leading-[1.05] tracking-[-0.025em] mb-5 text-white`}>Ordonex</h2>
                            <p className={`${interregular.className} text-base md:text-[1.05rem] text-white/50 font-normal leading-[1.75] mt-4`}>
