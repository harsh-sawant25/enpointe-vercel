...
const Page = () => {
    return (
        <div className={`${interregular.className} bg-[#171717] text-[#f5f5f0]`}>
            {/* Page Hero */}
            <section className="relative px-5 md:px-20 pt-40 pb-20 min-h-[60vh] flex flex-col justify-end border-b border-white/10 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 md:gap-[60px] mt-10 items-start">
                        ...
                        <div>
                            ...
                            <h3 className={`${interbold.className} text-[clamp(1.4rem,3vw,2.4rem)] font-bold leading-[1.1] tracking-[-0.02em] mb-4 text-white`}>Our Solution: Enterprise Offline AI Code Assistant</h3>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 md:gap-[60px] mt-10 items-start">
                        <div className="md:sticky md:top-24">
                            ...
                            <h2 className={`${interbold.className} text-[clamp(2rem,4.5vw,4rem)] font-bold leading-[1.05] tracking-[-0.025em] mb-5 text-white`}>Novo Cinemas AI Chatbot</h2>
                            <p className={`${interregular.className} text-base md:text-[1.05rem] text-white/50 font-normal leading-[1.75] mt-4`}>
                        ...
                        <div>
                            <div className="bg-[#A6DAFF]/6 border border-[#00e5c8]/20 p-8 md:p-10 mb-10">
                                <h4 className={`${interbold.className} text-[0.75rem] font-bold text-[#A6DAFF] tracking-[0.05em] uppercase mb-3`}>The Challenge</h4>
                                <p className={`${interregular.className} text-[0.9rem] text-[#F5F5F0]/50 leading-[1.7] font-normal`}>
                                    Manual handling of customer queries, high response times impacting booking conversions, limited personalisation in movie discovery, and disconnected booking, support, and information systems.
                                </p>
                            </div>

                            <h3 className={`${interbold.className} text-[clamp(1.4rem,3vw,2.4rem)] font-bold leading-[1.1] tracking-[-0.02em] mb-4 text-white`}>Conversational AI Booking Ecosystem</h3>
                            <p className={`${interregular.className} text-[0.9rem] text-white/40 mt-3 leading-[1.7] font-normal mb-7`}>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 md:gap-[60px] mt-10 items-start">
                        <div className="md:sticky md:top-24">
                            ...
                            <h2 className={`${interbold.className} text-[clamp(2rem,4.5vw,4rem)] font-bold leading-[1.05] tracking-[-0.025em] mb-5 text-white`}>Meldit AI</h2>
                            <p className={`${interregular.className} text-base md:text-[1.05rem] text-white/50 font-normal leading-[1.75] mt-4`}>
